...
function scroll_to(id) {
    ...
    ele.style.scrollMarginTop = "2rem";
    ele.scrollIntoView();
}
...
async function copy_link(tar, btn_text = "Copy Link") {
    ...
    const currentPath = new URL(window.location.href).toString();
